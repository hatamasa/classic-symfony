...
class MemberCollectionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function 指定した属性のメンバーが追加されていること()
    {
        ...
        $this->assertThat($memberCollection->count(), $this->equalTo(1),'追加後のコレクションの要素数が1か');
        ...
        $this->assertThat($member->getPart(), $this->equalTo('testpart'),'partプロパティに設定されているか');
        $this->assertThat($member->getJoinedDate(), $this->equalTo('2015-01-15'),'joinedDateプロパティに設定されているか');
    }
}